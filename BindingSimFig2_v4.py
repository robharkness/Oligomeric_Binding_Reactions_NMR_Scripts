...
def main():
    ...
    ### Intramolecular conformational exchange of protomers can be modeled by adding additional
    ### equilibrium constants such as K_conf = [PP*]/[PP] for a dimer and modifying the 
    ### nonlinear solver function to account for this equilibrium
...
def plot_result(Plot_dict, sim_params, spec_dict):
    ...
    # Set up plotting options for nice plots
